...
GRAPHDB_ENDPOINT: str = os.getenv("GRAPHDB_ENDPOINT")  # pyright: ignore[reportAssignmentType]
...
def execQuery(query: str) -> dict[str, Any] | Exception:  # pyright: ignore[reportExplicitAny]
    sparql = SPARQLWrapper(GRAPHDB_ENDPOINT)
    sparql.setQuery(query)
    sparql.setReturnFormat(JSON)

    try:
        return sparql.query().convert() # type: ignore  # pyright: ignore[reportReturnType]
